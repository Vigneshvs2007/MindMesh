 ...
 */
let SynthesisTools = class SynthesisTools {
    memory;
    embeddings;
    constructor(memory, embeddings) {
        this.memory = memory;
        this.embeddings = embeddings;
    }
    async clusterPapers(input, ctx) {
    ...
    generateClusterSummary(cluster, claims) {
    ...
    async findContradictoryClaims(input, ctx) {
    ...
    checkContradiction(claimA, claimB) {
        // Simple heuristic: same type, different papers, conflicting keywords
        if (claimA.paperId === claimB.paperId)
            return null;
    ...
    async synthesizeClusters(input, ctx) {
    ...
    generateOverallNarrative(syntheses) {
...
], SynthesisTools.prototype, "clusterPapers", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], SynthesisTools.prototype, "findContradictoryClaims", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], SynthesisTools.prototype, "synthesizeClusters", null);
SynthesisTools = __decorate([
    Injectable({ deps: [MemoryStore, EmbeddingsService] }),
    __metadata("design:paramtypes", [MemoryStore,
        EmbeddingsService])
], SynthesisTools);
export { SynthesisTools };
//# sourceMappingURL=synthesis.tools.js.map