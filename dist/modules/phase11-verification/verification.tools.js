 ...
 */
let VerificationTools = class VerificationTools {
    memory;
    constructor(memory) {
        this.memory = memory;
    }
    async verifyClaim(input, ctx) {
    ...
    async verifyMethodologyConsistency(input, ctx) {
    ...
    async compileVerificationSummary(input, ctx) {
        const { sessionId } = input;
    ...
    async runAllVerifications(input, ctx) {
        const { sessionId } = input;
    ...
    areContradictory(desc1, desc2) {
        ...
        for (const [a, b] of opposites) {
            if (desc1.includes(a) && desc2.includes(b))
                return true;
            if (desc1.includes(b) && desc2.includes(a))
                return true;
        }
        return false;
    }
...
], VerificationTools.prototype, "verifyClaim", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], VerificationTools.prototype, "verifyCitation", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], VerificationTools.prototype, "verifyMethodologyConsistency", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], VerificationTools.prototype, "compileVerificationSummary", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], VerificationTools.prototype, "runAllVerifications", null);
VerificationTools = __decorate([
    Injectable({ deps: [MemoryStore] }),
    __metadata("design:paramtypes", [MemoryStore])
], VerificationTools);
export { VerificationTools };
