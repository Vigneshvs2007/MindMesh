 ...
 */
let GapFinderTools = class GapFinderTools {
    memory;
    embeddings;
    ...
    async proposeGap(input, ctx) {
        ...
        const themePaperCounts = new Map();
    ...
    generateGapClaim(topic, topThemes, underexploredThemes, contradictions) {
...
], GapFinderTools.prototype, "assessNovelty", null);
__decorate([
    Tool({
        name: 'propose_gap',
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], GapFinderTools.prototype, "proposeGap", null);
__decorate([
    Tool({
        name: 'rank_gaps',
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], GapFinderTools.prototype, "rankGaps", null);
GapFinderTools = __decorate([
    Injectable({ deps: [MemoryStore, EmbeddingsService] }),
    __metadata("design:paramtypes", [MemoryStore,
        EmbeddingsService])
], GapFinderTools);
export { GapFinderTools };
//# sourceMappingURL=gap-finder.tools.js.map