 ...
 */
let VerdictTools = class VerdictTools {
    memory;
    constructor(memory) {
        this.memory = memory;
    }
    async computeResilienceScore(input, ctx) {
    ...
    buildReasoning(gap, reviews, resilienceScore, resilienceResult) {
    ...
    getRecommendations(verdict, score) {
        if (verdict === 'PASS') {
            return [
    ...
    async getVerdictHistory(input, ctx) {
...
], VerdictTools.prototype, "computeResilienceScore", null);
__decorate([
    Tool({
        name: 'render_verdict',
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], VerdictTools.prototype, "renderVerdict", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], VerdictTools.prototype, "getVerdictHistory", null);
VerdictTools = __decorate([
    Injectable({ deps: [MemoryStore] }),
    __metadata("design:paramtypes", [MemoryStore])
], VerdictTools);
export { VerdictTools };
//# sourceMappingURL=verdict.tools.js.map