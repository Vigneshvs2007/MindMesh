 ...
 */
let OverleafTools = class OverleafTools {
    overleaf;
    memory;
    constructor(overleaf, memory) {
        this.overleaf = overleaf;
        this.memory = memory;
    }
    ...
    async pushSection(input, ctx) {
        ...
        if (sessionId) {
            ...
            this.memory.updateSession(sessionId, { updatedAt: new Date().toISOString() });
        }
        return { section, pushed: true, contentLength: content.length };
    }
    async pushLimitations(input, ctx) {
    ...
    async addBibliography(input, ctx) {
  ...
  */
    async syncSession(input, ctx) {
        ...
        if (!projectInfo.projectId && createIfMissing) {
            ...
            const authors = session.papers.length > 0
                ...
                : ['Author'];
            const result = await this.overleaf.createProject(session.topic || 'Untitled Paper', authors, 'ieee');
            projectCreated = true;
    ...
    extractSectionsFromSession(session) {
        const sections = {};
...
], OverleafTools.prototype, "createProject", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OverleafTools.prototype, "pushSection", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OverleafTools.prototype, "pushLimitations", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OverleafTools.prototype, "addBibliography", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OverleafTools.prototype, "syncSession", null);
OverleafTools = __decorate([
    Injectable({ deps: [OverleafService, MemoryStore] }),
    __metadata("design:paramtypes", [OverleafService,
        MemoryStore])
], OverleafTools);
export { OverleafTools };
//# sourceMappingURL=overleaf.tools.js.map